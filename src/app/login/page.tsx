...
function LoginPageContent() {
  ...
  const onSignupSubmit = async (values: SignupFormValues) => {
    ...
    try {
      ...
      await createUserWithEmailAndPassword(auth as Auth, values.email, values.password);
      router.push(`/${userType}/profile`);
    } catch (error: any) {
      handleAuthError(error, toast);
    } finally {
            ...
            <TabsContent value="signup">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Create an account to get started with CuraLink.</CardDescription>
                </CardHeader>
                <CardContent>
                  <Form {...signupForm}>
