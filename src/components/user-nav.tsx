...
export function UserNav({ userType }: UserNavProps) {
    ...
    const userName = userType === 'patient' ? 'Jane Doe' : 'Dr. Alan Grant';
    const userEmail = userType === 'patient' ? 'jane.doe@email.com' : 'alan.grant@email.com';
            ...
            <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="h-auto w-full justify-start gap-2 p-2">
                    <Avatar className="h-10 w-10 border">
                        <AvatarImage src={`https://picsum.photos/seed/${avatarSeed}/100/100`} alt={userName} />
